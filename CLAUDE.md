...
### Fixes recientes
- **16-sep-2026 — Link de la oferta para que un cliente externo la firme.** Ver sección arriba — depende de que "Cualquier persona con el enlace" esté habilitado en SharePoint (no verificable desde aquí). Aplicado también en V1.
