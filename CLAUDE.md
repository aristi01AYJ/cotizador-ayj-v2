...
### Fixes recientes
- **17-sep-2026 — Editar "Posible Cierre" directo desde el Historial (columna Seguimiento + modal, sin crear revisión).** A pedido del usuario, para poder llenar retroactivamente ofertas viejas sin generar una revisión -Rn por cada una. Ver sección arriba. Aplicado también en V1.
- **17-sep-2026 — Columna `PosibleCierre` (registro histórico de qué opción 30/60/90/Personalizada se eligió).** A pedido del usuario, para tener trazabilidad además de la fecha calculada. Ver sección de FechaCierre y "Feature: Posible Cierre" arriba. Aplicado también en V1.
